...
export default function NewCoordinatorModalModal({ open, onClose, onSubmit }: ModalProps) {
  ...
  useEffect(() => {
    const getInstitutions = async () => {
      try {
        const fetchedData = await api.get('/admin/institutions', {withCredentials: true})
